package com.vrm.whiteboard.presentation.whiteboard.component
...
fun TopBar(
    ...
    Row(
        ...
        FilledIconButton(onClick = { onHomeIconClick()}, modifier = modifier) {
            Icon(
        ...
        FilledIconButton(onClick = { onUndoIconClick}, modifier = modifier) {
            Icon(
        ...
        FilledIconButton(onClick = { onRedoIconClick }, modifier = modifier) {
            Icon(
        ...
        Box{
            FilledIconButton(onClick = { isMoreOptionsMenuOpen = true}, modifier = modifier) {
                Icon(
